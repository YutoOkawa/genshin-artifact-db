...
type MockCreateArtifactService struct {
	MockCreateArtifactError error
}

func (s *MockCreateArtifactService) CreateArtifact(artifactCommand CreateArtifactCommand) error {
	return s.MockCreateArtifactError
}
